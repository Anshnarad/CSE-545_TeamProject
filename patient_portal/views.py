...
"""def index(request):
    return HttpResponse("Hello, world. You've visited the Medical Records page in the Patient portal.")
def labtests(request,patient_id):
    return HttpResponse("Hello, world. You've visited the labtests page in the Patient portal.")
def payments(request):
    return HttpResponse("Hello, world. You've visited the payments page in the Patient portal.")
def transactions(request):
    return HttpResponse("Hello, world. You've visited the transactions page in the Patient portal.")
